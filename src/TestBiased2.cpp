...
void BiasedSimulations2() {
  ...
  Reporter reporter(100, atoms, "XYZ_100_10_b.traj");
  std::ofstream ofs_restraint_traj("restraint_100_10.dat");
  ...
  ofs_bias_traj << fmt::format("#{:>10s} ", "step")
                ...
                << fmt::format("{:>12s} {:>12s}\n", "fb_rx", "fb_ry");
  std::ofstream ofs_hill_traj("bias_100_10.hills");
  ...
  simulation.runLangevinDynamics(
      ...
      [&](){
        ...
        bias.writeOutput("bias_100_10_step");
